extends Node2D
@onready var garlic_container: Node = $lives
@onready var garlic: TextureRect = $"lives/1"
@onready var garlic_2: TextureRect = $"lives/2"
@onready var garlic_3: TextureRect = $"lives/3"
@onready var garlic_4: TextureRect = $"lives/4"
@onready var garlic_5: TextureRect =$"lives/5"
...
# should be next. Make sure you name your minigame saves appropriately.
		...
		get_tree().change_scene_to_file("res://scene/winscreen.tscn") # changes your scene
